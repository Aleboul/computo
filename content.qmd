...
While software implementation of copulas has been thoroughly explored in $\textsf{R}$
...
pairwise dependence between maxima in space, see \emph{e.g.} @bernard:hal-03207469 @BADOR201517 @saunders where the madogram was used as a dissimilarity 
